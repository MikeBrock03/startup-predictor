...
def prepare_data_NN(X_train, y_train, X_val, y_val, X_test, y_test, batch_size=32):
...
def main():
    ...
    hidden_layers = [5, 4, 4]
    customNN = BinaryClassifier(X_train.shape[1], hidden_layers)
    
    criterion = nn.BCELoss()
    optimizer = optim.Adam(customNN.parameters(), lr=0.001)
